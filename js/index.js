$(function () {
    ...
    function initEvents() {
        ...
        // 2.监听复选框的点击事件
        $(".content_list").delegate("#all_check", "click", function () {
            $('#all_check').toggleClass("list_checked");
            if($('#all_check').hasClass('list_checked')){
        ...
        // 7.监听删除清空按钮的点击
        $(".content_toolbar").delegate("#remove_list", "click", function () {
            var $item = $(".list_music");
            $item.remove();
        ...
        $(".content_toolbar").delegate("#delete_list", "click", function () {
            ...
            $item.each(function(){
               ...
               if($(this).get(0).index == player.currentIndex)
             {
